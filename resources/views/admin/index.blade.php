            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item dropdown u-pro">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/admin/images/users/1.jpg" alt="user" class="" /> <span class="hidden-md-down">Mark Sanders &nbsp;</span> </a>
                    </li>
                </ul>
            </div>
        </nav>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-20 no-wrap">
                                <table class="table vm no-th-brd pro-of-month">
                                    ...
                                    <tr class="active">
                                        <td><span class="round"><img src="/admin/images/users/2.jpg" alt="user" width="50"></span></td>
                                        <td>
...
<script src="/admin/node_modules/bootstrap/js/popper.min.js"></script>
<script src="/admin/node_modules/bootstrap/js/bootstrap.min.js"></script>
